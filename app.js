      ...
      <div class="fact-panel-body">
        ...
        <div class="fact-fields">
          ...
          <div class="fact-field">
            ...
            <span style="font-size:13px;font-weight:600;color:var(--text);margin-top:3px;font-family:'DM Mono',monospace;user-select:text;cursor:text">ARCA: ${Math.round(ultimoPago.monto)}</span>
          </div>
          <div class="fact-field">
