  ...
  lista.forEach(([vid, v]) => {
    ...
    row.innerHTML = `
      ...
      <button class="pago-historial-btn" title="Historial de pagos" data-vid="${vid}">
        ...
        <span class="btn-texto-pc">Historial de pagos</span>
      </button>
      ${esPagado ? `<button class="pago-recibo-btn" title="Descargar recibo PDF" data-vid="${vid}">
        ...
        <span class="btn-texto-pc">Descargar recibo PDF</span>
      </button>` : ""}
    `;
...
// ============================================================
const TITULOS = { mapa: "Cocheras", vehiculos: "Vehículos", alquileres: "Alquileres", pagos: "Pagos", espera: "Lista de espera", mantenimiento: "Mantenimiento", gastos: "Impuestos y Servicios", mensajes: "Mensajes", facturacion: "Facturación", backup: "Backup" };
...
function exportarJSON() {
  const datos = { vehiculos, pagos, espera: listaEspera, mantenimiento, gastos, facturacion, config: { totalEspacios } };
